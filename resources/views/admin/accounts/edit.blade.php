...
@section('content')
    <div class="space-y-6">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('admin.accounts.show', $account) }}" class="ml-1 text-sm font-medium text-[#706f6c] hover:text-[#1b1b18] dark:text-[#A1A09A] dark:hover:text-[#EDEDEC] md:ml-2">{{ Str::limit($account->account_title, 30) }}</a>
                    </div>
                </li>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold text-[#1b1b18] dark:text-[#EDEDEC]">Edit Account</h1>
                <div class="flex items-center space-x-3 mt-2">
                    <p class="text-[#706f6c] dark:text-[#A1A09A]">{{ $account->account_title }}</p>
                    <span class="text-[#706f6c] dark:text-[#A1A09A]">•</span>
                    <p class="text-[#706f6c] dark:text-[#A1A09A]">{{ $account->branch->name ?? 'No branch' }}</p>
                    <span class="text-[#706f6c] dark:text-[#A1A09A]">•</span>
                    ...
                    <div class="col-span-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-[#706f6c] dark:text-[#A1A09A]">{{ $account->branch->name ?? 'No branch' }}</span>
                            </div>
                            <div class="flex items-center space-x-2">
                                <svg class="w-4 h-4 text-[#706f6c] dark:text-[#A1A09A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-[#706f6c] dark:text-[#A1A09A]">{{ $account->created_at->format('M j, Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white dark:bg-[#161615] rounded-xl border border-[#e3e3e0] dark:border-[#3E3E3A] overflow-hidden">
                ...
                <div class="p-6">
                    <div class="space-y-6">
                        <!-- Branch Selection -->
                        <div>
                            <label for="branch_id" class="block text-sm font-medium text-[#706f6c] dark:text-[#A1A09A] mb-2">
                            ...
                            <p class="mt-1 text-xs text-[#706f6c] dark:text-[#A1A09A]">
                                Select the branch where this account will be managed
                            </p>
                        </div>

                        <!-- Account Title -->
                        <div>
                            <label for="account_title" class="block text-sm font-medium text-[#706f6c] dark:text-[#A1A09A] mb-2">
            ...
            <div class="bg-white dark:bg-[#161615] rounded-xl border border-[#e3e3e0] dark:border-[#3E3E3A] overflow-hidden">
                <div class="px-6 py-4 bg-gray-50 dark:bg-[#1a1a19] border-b border-[#e3e3e0] dark:border-[#3E3E3A]">
                    <div class="flex items-center space-x-2">
                        ...
                        <h3 class="text-lg font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">Account Details</h3>
                    </div>
                </div>
                <div class="p-6">
                    <!-- Description -->
                    <div>
                        ...
                        @enderror
                        <p class="mt-1 text-xs text-[#706f6c] dark:text-[#A1A09A]">
                            Add notes or details about the account (optional)
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    ...
                    <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/10 rounded-lg border border-blue-200 dark:border-blue-800">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <h5 class="text-sm font-medium text-blue-900 dark:text-blue-100 mb-1">Before Updating Account</h5>
                                <ul class="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                                    <li>• Ensure all required fields are filled correctly</li>
                                    <li>• Select the appropriate branch for this account</li>
                                    <li>• Use a clear, descriptive account title</li>
