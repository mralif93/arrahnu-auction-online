                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div class="flex bg-[#f8f8f7] dark:bg-[#1a1a19] rounded-lg p-1">
                                        <button onclick="filterAccounts('all')" id="filter-all" class="px-3 py-1 text-sm font-medium rounded-md transition-colors bg-white dark:bg-[#161615] text-[#1b1b18] dark:text-[#EDEDEC] shadow-sm">
                                            All
                                        </button>
                                        <button onclick="filterAccounts('active')" id="filter-active" class="px-3 py-1 text-sm font-medium rounded-md transition-colors text-[#706f6c] dark:text-[#A1A09A] hover:text-[#1b1b18] dark:hover:text-[#EDEDEC]">
                                            Active
                                        </button>
                                        <button onclick="filterAccounts('pending_approval')" id="filter-pending_approval" class="px-3 py-1 text-sm font-medium rounded-md transition-colors text-[#706f6c] dark:text-[#A1A09A] hover:text-[#1b1b18] dark:hover:text-[#EDEDEC]">
                                            Pending
                                        </button>
                                        <button onclick="filterAccounts('draft')" id="filter-draft" class="px-3 py-1 text-sm font-medium rounded-md transition-colors text-[#706f6c] dark:text-[#A1A09A] hover:text-[#1b1b18] dark:hover:text-[#EDEDEC]">
                                            Draft
                                        </button>
                                    </div>

                                    <!-- Add Account Button -->
                                    <a href="{{ route('admin.accounts.create') }}" class="inline-flex items-center px-4 py-2 text-white text-sm font-medium rounded-lg border-0 cursor-pointer" style="background-color: #FE5000; position: relative; z-index: 10;" onmouseover="this.style.backgroundColor='#E5470A'" onmouseout="this.style.backgroundColor='#FE5000'">
                            ...
                            <table class="w-full">
                                ...
                                <tbody class="bg-white dark:bg-[#161615] divide-y divide-[#e3e3e0] dark:divide-[#3E3E3A]">
                                    @foreach($accounts as $account)
                                        <tr class="hover:bg-[#f8f8f7] dark:hover:bg-[#1a1a19] transition-colors account-row" data-status="{{ $account->status }}">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap border-r border-[#e3e3e0] dark:border-[#3E3E3A]">
                                                ...
                                                <div class="text-xs text-[#706f6c] dark:text-[#A1A09A]">
                                                    {{ $account->branch->location ?? 'No location' }}
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap border-r border-[#e3e3e0] dark:border-[#3E3E3A]">
                                                <div class="space-y-1">
                                                    <div class="text-sm font-medium text-[#1b1b18] dark:text-[#EDEDEC]">
                                                        {{ $account->collaterals->count() }} items
                                                    </div>
                                                    <div class="text-sm text-[#706f6c] dark:text-[#A1A09A]">
                                                        Total value: RM {{ number_format($account->collaterals->sum('estimated_value_rm'), 2) }}
                                                    </div>
                                                    <div class="text-xs">
