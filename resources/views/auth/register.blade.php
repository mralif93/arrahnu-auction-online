...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Create Account - Arrahnu Auction</title>
                ...
                <div class="bg-white dark:bg-[#161615] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-lg p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-[#706f6c] dark:text-[#A1A09A] text-sm">
                            Join our auction platform and start bidding today!
                        </p>
                    </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-6">
            ...
            <div class="flex items-start">
                <input
                    ...
                    type="checkbox"
                    required
                    class="h-4 w-4 mt-1 text-[#f53003] dark:text-[#FF4433] focus:ring-[#f53003] dark:focus:ring-[#FF4433] border-[#e3e3e0] dark:border-[#3E3E3A] rounded"
                >
                <label for="terms" class="ml-2 block text-sm text-[#706f6c] dark:text-[#A1A09A]">
                    I agree to the
                    <a href="#" class="font-medium text-[#f53003] dark:text-[#FF4433] hover:underline">
                        Terms of Service
                    </a>
                    and
                    <a href="#" class="font-medium text-[#f53003] dark:text-[#FF4433] hover:underline">
            ...
            <div>
                ...
                <div class="mt-6 p-4 bg-[#fff2f2] dark:bg-[#1D0002] border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-lg">
                    <h3 class="text-sm font-medium text-[#1b1b18] dark:text-[#EDEDEC] mb-2">Why Join Our Auction Platform?</h3>
                    <ul class="text-xs text-[#706f6c] dark:text-[#A1A09A] space-y-1">
                        <li>• Access to exclusive auction items</li>
