...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Arrahnu Auction - Premium Online Auctions</title>
    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC]">
                    ...
                    @if (Route::has('login'))
                        <div class="flex items-center gap-4">
                            @auth
                                <a
                                    href="{{ url('/dashboard') }}"
                                    class="inline-block px-5 py-2 dark:text-[#EDEDEC] border-[#19140035] hover:border-[#1915014a] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm font-medium transition-colors"
                                >
                                    Dashboard
                                </a>
                            @else
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="text-center lg:text-left">
                            <h1 class="text-4xl lg:text-6xl font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-6 leading-tight">
                                Discover Rare
                                <span class="text-[#f53003] dark:text-[#FF4433]">Treasures</span>
                                at Premium Auctions
                            </h1>
                            ...
                            <div class="bg-white dark:bg-[#161615] rounded-2xl shadow-2xl p-8 border border-[#e3e3e0] dark:border-[#3E3E3A]">
                                ...
                                <div class="space-y-6">
                                    <div class="flex items-center justify-between">
                                        <span class="text-sm font-medium text-[#f53003] dark:text-[#FF4433] bg-[#fff2f2] dark:bg-[#1D0002] px-3 py-1 rounded-full">
                                            Live Auction
                                        </span>
                                    ...
                                    <div class="aspect-square bg-gradient-to-br from-[#f53003]/10 to-[#f53003]/5 dark:from-[#FF4433]/10 dark:to-[#FF4433]/5 rounded-xl flex items-center justify-center">
                                        <svg class="w-16 h-16 text-[#f53003] dark:text-[#FF4433]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-[#706f6c] dark:text-[#A1A09A] mb-4">
                                            Rare 1960s model in excellent condition
                                        </p>
                                        <div class="flex items-center justify-between">
                                            <div>
                                                <p class="text-xs text-[#706f6c] dark:text-[#A1A09A]">Current Bid</p>
                                                <p class="text-xl font-bold text-[#f53003] dark:text-[#FF4433]">$15,750</p>
                                            </div>
                                            <button class="px-4 py-2 bg-[#f53003] dark:bg-[#FF4433] text-white text-sm font-medium rounded-lg hover:bg-[#d42a02] dark:hover:bg-[#e63322] transition-colors">
                                                Place Bid
                                            </button>
                                        </div>
                                    </div>
                ...
                <div class="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div class="text-center">
                            <div class="w-16 h-16 bg-[#f53003] dark:bg-[#FF4433] rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <section class="py-20 bg-[#fff2f2] dark:bg-[#1D0002]">
                <div class="max-w-7xl mx-auto px-6 lg:px-8">
                    <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
                        <div class="text-center">
                            <div class="text-3xl lg:text-4xl font-bold text-[#f53003] dark:text-[#FF4433] mb-2">
                                10K+
                            </div>
            ...
            <section id="auctions" class="py-20 bg-white dark:bg-[#161615]">
                <div class="max-w-7xl mx-auto px-6 lg:px-8 text-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        @endif
                        @if (Route::has('login'))
                            <a href="{{ route('login') }}" class="inline-flex items-center justify-center px-8 py-4 border-2 border-[#e3e3e0] dark:border-[#3E3E3A] text-[#1b1b18] dark:text-[#EDEDEC] font-semibold rounded-lg hover:border-[#f53003] dark:hover:border-[#FF4433] hover:text-[#f53003] dark:hover:text-[#FF4433] transition-colors">
                                Sign In
                            </a>
                        @endif
                    </div>
        ...
        <!-- Footer -->
        <footer id="about" class="sticky-footer bg-[#1b1b18] dark:bg-[#0a0a0a] text-white py-16">
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
